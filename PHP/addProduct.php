  ...
  <main class="content">
    ...
    <form action="inserirProduto.php" method="POST">
      <div class="input-field">
        <label for="sku" name = "sku" class="label">Product SKU</label>
        <input type="text" name ="sku" id="sku" class="input-text" /> 
      </div>
      <div class="input-field">
        <label for="name" class="label">Product Name</label>
        <input type="text" name ="nome" id="name" class="input-text" /> 
      </div>
      <div class="input-field">
      ...
      <div class="input-field">
        ...
        <select multiple name ="categories" id="category" class="input-text">
      ...
      <div class="actions-form">
        ...
        <input class="btn-submit btn-action" href ="inserirProduto.php" type="submit" value="Save Product" />
      </div>
